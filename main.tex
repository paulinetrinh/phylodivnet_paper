...
Alpha diversity may be of particular interest when understanding whether species diversity is related to some characteristic of the site whereas beta diversity is of particular interest when understanding whether species composition differs between sites. (What do I want to say about alpha and beta diversity here that might transition into focusing on beta diversity?)

Beta diversity is particularly useful when comparing whether microbial composition differs between samples or even between samples grouped by some characteristic. Beta diversity metrics
